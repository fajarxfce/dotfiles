...
# ── Lepaskan terminal dari mode mouse-reporting yang nyangkut ────────────────
# TUI lewat SSH (tmux/vim/htop/btop) menyalakan mouse tracking dengan CSI ?1003h.
# Kalau koneksi mati sebelum dia sempat mengirim pasangan `...l`-nya, terminal
# tetap melapor selamanya: tiap gerakan mouse masuk ke prompt sebagai teks
# `35;86;45M` (format SGR: tombol;kolom;baris). Mematikannya sebelum tiap prompt
# gratis dan tidak mengganggu TUI yang sedang jalan, karena precmd baru menyala
# saat kita sudah kembali ke shell.
_reset_mouse_reporting() {
    print -n '\e[?1000l\e[?1002l\e[?1003l\e[?1004l\e[?1005l\e[?1006l\e[?1015l'
}
